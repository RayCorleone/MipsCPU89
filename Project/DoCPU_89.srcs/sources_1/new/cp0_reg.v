	...
	always @ (posedge clk) begin
      ...
      timer_int_o <= `InterruptNotAssert;
		  ...
		  cause_o[15:10] <= int_i;
			...
			case (excepttype_i)
				32'h00000001:		begin    // 中断发生 interrupt
				...
				32'h00000008:		begin    // 系统调用 syscall
				...
				32'h0000000a:		begin    // 无效指令 inst_invalid
					if(status_o[1] == 1'b0) begin
						if(is_in_delayslot_i == `InDelaySlot ) begin
							epc_o <= current_inst_addr_i - 4 ;
							cause_o[31] <= 1'b1;
